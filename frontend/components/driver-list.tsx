  ...
  return (
    <section className="rounded-2xl border border-seam bg-surface p-5 shadow-panel">
      <div className="mb-4 flex items-center justify-between gap-4">
        <div>
          <p className="mb-1 eyebrow text-[10px] text-ink/35">
            Market Drivers
          </p>
          <h2 className="text-lg font-semibold text-ink">Why the forecast is moving</h2>
        </div>
        <span className="eyebrow text-[10px] text-ink/25">
          Linked evidence
        </span>
      </div>
          ...
          const inner = (
            ...
            >
              <div className="flex flex-wrap items-center gap-2 mb-2">
                <p className="eyebrow text-[10px] font-semibold text-ink/55">
                  {driver.title}
                </p>
                {driver.sourceName && (
                  <span className="rounded bg-ink/5 px-1.5 py-0.5 eyebrow text-[9px] text-ink/35">
                    {driver.sourceName}
                  </span>
                )}
              </div>
              ...
              {(driver.href || driver.sourceMeta) && (
                <div className="mt-3 flex flex-wrap items-center gap-3 eyebrow text-[9px] text-ink/28">
