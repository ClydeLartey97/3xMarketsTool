...
/** Quiet sentence-case label sitting at the top-left of every panel. */
export const labelClass =
  "text-xs font-medium text-ink/45";
...
export const tagClass =
  "rounded-md bg-ink/5 px-1.5 py-0.5 text-[11px] font-medium text-ink/65";
...
export const counterClass =
  "rounded-md bg-ink/5 px-1.5 py-0.5 text-[11px] font-medium lowercase text-ink/55";
